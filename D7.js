...
*/
const str = function (para1, para2){
  const str1 = para1.substring(0, 2);
  const str2 = para2.substring(3, 6);
  const risul= str1 + str2;
  console.log(risul.toUpperCase());
}
str ("Banana", "Melograno");
...
for( let i=0; i<10; i++) {
   ...
   console.log("I numeri casuali sono: "+ num);
}

/* ESERCIZIO 3
  Scrivi una funzione per ricavare solamente i valori PARI 
  da un array composto da soli valori numerici
 (suggerimento: il metodo filter può aiutare)
*/
const num = [10, 15, 30, 45, 33, 29, 7, 55, 368, 254];
const nump = num.filter((numero)=>numero%2===0);
console.log(nump);
